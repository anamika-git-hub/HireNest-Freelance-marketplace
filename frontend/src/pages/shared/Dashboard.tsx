...
import { FaBell, FaEllipsisH, FaClock, FaUsers, FaUserCircle } from "react-icons/fa";
...
const Dashboard: React.FC = () => {
  return (
    <section className="bg-blue-100 w-full">
      <div className="p-6 pt-36 space-y-6 mx-20">
        {/* Stats Section */}
            ...
            <ul className="space-y-6">
              <li className="border-b pb-4">
                ...
                <div className="mt-3 flex items-center">
                  <button className="bg-blue-600 text-white text-sm font-medium px-3 py-1 rounded flex items-center">
                    Manage Bidders
                    <span className="ml-2 bg-white text-blue-600 text-xs px-2 py-0.5 rounded-full">3</span>
                  </button>
