...
const TaskDetail: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen pt-20 text-gray-800">
      <div className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row md:items-start justify-between bg-white p-6 rounded-lg shadow-lg mb-8">
